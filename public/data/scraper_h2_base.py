...
def scrape_recursive_links_to_json(html_content):
    ...
    def get_heading_layer(tag_name):
        heading_layers = {'h2': 1, 'h3': 2, 'h4': 3, 'h5': 4, 'h6': 5}
    ...
    def process_content_with_headings():
        ...
        content_elements = soup.find_all(['h2', 'h3', 'h4', 'h5', 'h6', 'ol'])
...
if __name__ == '__main__':
    ...
    urls = {
        ...
        "biology_and_health_sciences": "https://en.wikipedia.org/wiki/Wikipedia:Vital_articles/Level/4/Biology_and_health_sciences",
        "physical_sciences": "https://en.wikipedia.org/wiki/Wikipedia:Vital_articles/Level/4/Physical_sciences",
